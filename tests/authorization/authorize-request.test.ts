...
describe("worker entrypoint wiring", () => {
  ...
  it("resolves an existing USER_SESSIONS_KV browser session for the authenticated authorize fast-path", async () => {
    vi.resetModules();
    ...
    const browserSessionToken = "browser-session-token";
